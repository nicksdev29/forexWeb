...
<head>
	...
	<title>Upgrade to Pro | SAMFXT</title>
	...
	<?php include'usersidemenu.php'?>
				...
				<div class="sidebar-cta">
					<div class="sidebar-cta-content">
						<strong class="d-inline-block mb-2">SAMFXT</strong>
						<div class="mb-3 text-sm">
							SAMFXT
						</div>
						<div class="d-grid">
							<a href="upgrade-to-pro.php" class="btn btn-primary">SAMFXT</a>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="col-12 col-md-11 col-lg-10 col-xl-8 col-xxl-6 mx-auto">
							<div class="card">
								...
								<div class="card-header">
									<h5 class="card-title">SAMFXT</h5>
									<h6 class="card-subtitle text-muted">SAMFXT </h6>
								</div>
								<div class="card-body">
				...
				<div class="container-fluid">
					<div class="row text-muted">
						<div class="col-6 text-start">
							<p class="mb-0">
								<a class="text-muted" href="https://adminkit.io/" target="_blank"><strong>SAMFXT</strong></a> - <a class="text-muted" href="https://adminkit.io/" target="_blank"><strong>SAMFXT</strong></a>								&copy;
							</p>
						</div>
