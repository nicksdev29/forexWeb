					...
					<div class="row">
						...
						<?php
							if(isset($_POST) && isset($_POST['package_title']) ) {
								...
								$query = "update packages set `package_title`='".$_POST['package_title']."', `description`='".$_POST['description']."', `content_json`='".$content_json."' where `id`=".$packagesId;
								try {
