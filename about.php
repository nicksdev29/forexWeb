            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        ...
                        <h1 class="mb-4">About <span class="text-primary text-uppercase">us</span></h1>
                        <p class="mb-4">Incorporated in 2022 , SAM Foreign Exchange & Travels Services Pvt Ltd is licensed by the Reserve Bank of India to provide money changing services. The company has opened its first branch at Bangalore and have planned to extend other parts of India. The company is owned and run by professional staffs. The Directors have more than 30 yrs of experience in Fx market in India and in abroad. The Travel wing is providing facilities to all customers from India and abroad to book tours , hotels and tickets online and pay directly to our account via payment gateway.
                        </p></div>
            ...
            <div class="container col-md-12">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-8">
                        <div class="row g-3">
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.1s" src="img/tr1.png" style="margin-top: 25%;">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.3s" src="img/tr2.png">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-50 wow zoomIn" data-wow-delay="0.5s" src="img/tr3.png">
                            </div>
                            <div class="col-6 text-start">
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="rounded shadow overflow-hidden">
                            <div class="position-relative">
                                <img class="img-fluid" src="samfxt-staffs-photo/samfxt-director-supratim-roy.jpeg" alt="">
                                <div class="position-absolute start-50 top-100 translate-middle d-flex align-items-center">
                                    <a class="btn btn-square btn-primary mx-1" href=""><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-square btn-primary mx-1" href=""><i class="fab fa-twitter"></i></a>
                                    <a class="btn btn-square btn-primary mx-1" href=""><i class="fab fa-instagram"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="rounded shadow overflow-hidden">
                            <div class="position-relative">
                                <img class="img-fluid" src="samfxt-staffs-photo/samfxt-director-mithu-roy.jpeg" alt="">
                                <div class="position-absolute start-50 top-100 translate-middle d-flex align-items-center">
                                    <a class="btn btn-square btn-primary mx-1" href=""><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-square btn-primary mx-1" href=""><i class="fab fa-twitter"></i></a>
                                    <a class="btn btn-square btn-primary mx-1" href=""><i class="fab fa-instagram"></i></a>
