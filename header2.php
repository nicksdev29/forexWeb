...
<body>
    ...
    <b>Tokyo&nbsp; </b> |&nbsp; <p id="tokyoTime" style="padding-top: 18px"></p> &nbsp;&nbsp;&nbsp;&nbsp;
    <b>HongKong&nbsp; </b> |&nbsp; <p id="hongkongTime" style="padding-top: 18px"></p> &nbsp;&nbsp;&nbsp;&nbsp;
    <b>Mumbai </b>&nbsp; |&nbsp; <p id="mumbaiTime" style="padding-top: 18px"></p> &nbsp;&nbsp;&nbsp;&nbsp;
    <b>Dubai </b>&nbsp; |&nbsp; <p id="dubaiTime" style="padding-top: 18px"></p> &nbsp;&nbsp;&nbsp;&nbsp;
    <b>London </b>&nbsp; | &nbsp;<p id="londonTime" style="padding-top: 18px"></p> &nbsp;&nbsp;&nbsp;&nbsp;
    <b>New York </b>&nbsp; |&nbsp; <p id="newyorkTime" style="padding-top: 18px"></p> &nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                        ...
                        <h1 class="m-0 text-primary text-uppercase">SAM FXT</h1>
                        </a>
