                    ...
                    <div class="col-md-15">
                        <div class="row gy-4">
                            <div class="col-md-3">
                                ...
                                <p>
                                    <i class="fa fa-map-marker text-primary me-2"></i>146/48,3RD MAIN,6TH BLOCK,
                                               &nbsp; JAYANAGAR,BANGALORE</p>
                            </div>
                            <div class="col-md-2">
                                <h6 class="section-title text-start text-primary text-uppercase">E-mail</h6>
                                <p><i class="fa fa-phone text-primary me-2"></i>INFO@SAMFXT.IN</p>
                            </div>
                            <div class="col-md-5">
                                <h6 class="section-title text-start text-primary text-uppercase">Phone</h6>
                                <p><i class="fa fa-mobile text-primary me-2"></i>+91 7439841376 / +91 9007917596
</p>
                            </div>
                             <div class="col-md-2">
