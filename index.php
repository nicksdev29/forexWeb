                        ...
                        <div class="col-md-12">
                            <div class="row g-2">
                                ...
                                <div class="date" id="date1" data-target-input="nearest"> 
                                    ...
                                    <p align="center"><b> </b><h1 align="center">
                                        
                                    </h1>
                                    <p align="center">Competitive rate for popular currencies when you buy or sell.<br>
                                    ...
                                    <p align="center">
                                    <a class="btn btn-sm btn-dark rounded py-2 px-4" href="" style="background-color: #FEA116; border: 0px;">FOREIGN EXCHCANGE</a>
                                    </p>  
                                </div>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <p align="center"><img src="img/transportation2.png" alt="currency note" width="92%" align="center"></p>
                                    <p align="center"> <b> </b><h1 align="center"> </h1>
                                    </p>
                                    <p align="center">Vietnam/Cambodia, Malaysia/Singapore, 
                                     <br>China Hong Kong; Macau, Dubai, Egypt,<br>Europe and African Safari etc.</p>
                                    <p align="center">
                                    <a class="btn btn-sm btn-dark rounded py-2 px-4" href="" style="background-color: #FEA116; border: 0px;">INTERNATIONAL</a>
                                    </p>
                                </div>
                                </div>
                                <div class="col-md-3">
                               ...
                               <br>
                                ...
                                <p align="center" > 
                                       <ul class="forex bg-dark text-light" style="list-style-type:none;">
                                          ...
                                          <li><i class="fa fa-paper-plane text-primary me-2"></i> Become an Agent</li> 
